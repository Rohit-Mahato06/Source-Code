...
<hr />
<div class="mx-4">
    <h1 class="my-4 font-bold text-2xl">Comments</h1>
    <div class="bg-black h-1"></div>
    <div class="mt-5 flex">
        <a href="create.php" class="px-2 ml-auto py-1 bg-blue-500 rounded-md text-white">add Comments</a>
    </div>
    <!-- table -->
    <?php
    include 'cmt_table.php';
    ?>
    <!-- end of table -->
</div>
<?php
