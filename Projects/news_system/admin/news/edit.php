...
<hr />
<div class="mx-4">
    <h1 class="my-4 font-bold text-2xl">Edit news</h1>
    ...
    <div class="mt-5 w-1/2">
        <form method="POST" action="cat_action.php">
            ...
            <input type="text" id="name" name="news_name" class="border w-full border-black p-2 outline-none rounded" value="<?php echo $data['name'] ?>">
            <button name="news_edit" type="submit" class="px-2 py-1 my-2 bg-blue-500 rounded-md text-white">
                Change
            </button>
        </form>
    </div>
